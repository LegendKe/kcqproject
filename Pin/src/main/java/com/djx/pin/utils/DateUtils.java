...
public class DateUtils {
	...
	/*
	 * before和now的日期格式必须是"2013-5-15"这种格式
	 */
	public static long SubtractionDate(String before, String now) {
	...
	// 获取当前日期.格式为2016年01月01日
	public static String getCurrentDate() {
		String date = null;
		try {
			date = dateToString(Calendar.getInstance().getTime(),
					LOCALE_DATE_FORMAT);
		} catch (Exception e) {
			// TODO 自动生成的 catch 块
			e.printStackTrace();
