 ...
 */
public class LifeRewardOnLineCommentAdapter extends RecyclerView.Adapter<LifeRewardOnLineCommentAdapter.ViewHolder> implements View.OnClickListener {


    private Context context;
    OnCommentAvatarListener onCommentAvatarListener;
    List<LifeRewardOnlineDetailInfo.Result.Comment> list;
    LayoutInflater inflater;

    View HeaderView;
    View FooterView;
    Map urlMap;
    public LifeRewardOnLineCommentAdapter(Context context,OnCommentAvatarListener onCommentAvatarListener) {
    ...
    public void addData(LifeRewardOnlineDetailInfo.Result.Comment info) {
        list.add(info);
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case 0:
                v = inflater.inflate(R.layout.lv_item_comment, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        if (position > 0 && position < list.size() + 1) {
            LifeRewardOnlineDetailInfo.Result.Comment commentInfo = list.get(position - 1);
            holder.tv_NickName_MHDA.setText(commentInfo.nickname);
            holder.tv_time_MHDA.setText(TurnIntoTime.getCreateTime(commentInfo.create_time));

          holder.tv_ShareCotent_MHDA.setText(commentInfo.content);

            try {
                getOneImageViewUrl(holder.cimg_Avatar_MHDA,commentInfo.portrait,1,50,50);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            tv_ShareCotent_MHDA = (TextView) itemView.findViewById(R.id.tv_CommentContent);
            cimg_Avatar_MHDA = (CircleImageView) itemView.findViewById(R.id.civ_avatar);
        }
    }
    /**
