 ...
 */
public class MyHelperOnlineRewardAdapter extends MyBaseAdapter<MyHelperListInfo.LIST> {
    protected final static String TAG = MyHelperOnlineRewardAdapter.class.getSimpleName();

    public MyHelperOnlineRewardAdapter(Context context) {
        super(context);
    }
