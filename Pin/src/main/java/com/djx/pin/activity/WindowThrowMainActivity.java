...
public class WindowThrowMainActivity extends OldBaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_windowthrow);
        initView();
        initEvent();
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.rl_report_now:
                ...
                //startActivity(new Intent(WindowThrowMainActivity.this, WindowThrowUpdataInfoActivity.class));
            ...
            case R.id.rl_report_history:
                ...
                startActivity(new Intent(this, WindowThrowHistoryActivity.class));
                break;
            //点击使用说明按钮
            case R.id.rl_instruction:
                startActivity(new Intent(this, WindowThrowInstructionActivity.class));
                break;
        }
